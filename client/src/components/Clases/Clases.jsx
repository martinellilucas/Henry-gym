      ...
      <div className={style.cardsContainer}>
        ...
        >
          ...
          <Stack>
            ...
            <Text color={"gray.500"}>
              ...
              adapt to the natural movements of the human body to work muscles
              and joints globally. One of its main advantages is that they fully
              adapt to the physical conditions of each person. that is why it is
              very effective as personal training.
            </Text>
          </Stack>
          <Stack mt={6} direction={"row"} spacing={4} align={"center"}>
        ...
        >
          ...
          <Stack>
            ...
            <Text color={"gray.500"}>
              ...
              meditation to improve overall health. Yoga developed as a
              spiritual practice thousands of years ago. Nowadays, most people
              in the west who practice yoga do so for exercise or to reduce
              stress.
            </Text>
          </Stack>
          <Stack mt={6} direction={"row"} spacing={4} align={"center"}>
        ...
        >
          ...
          <Stack>
            ...
            <Text color={"gray.500"}>
              <b>Zumba</b> is a sports discipline that is taught in guided
              classes in which aerobic exercises are performed to the rhythm of
              Latin music (merengue, samba, reggaeton, cumbia and salsa) in
              order to lose weight in a fun way and improve the mood of the
              athletes.
            </Text>
          </Stack>
          <Stack mt={6} direction={"row"} spacing={4} align={"center"}>
        ...
        >
          ...
          <Stack>
            ...
            <Text color={"gray.500"}>
              ...
              superficial, increasing and uniting dynamism and muscular power
              with mental control, relaxation and breathing.{" "}
            </Text>
          </Stack>
          <Stack mt={6} direction={"row"} spacing={4} align={"center"}>
            <Avatar src={Entrenador1} alt={"Author"} />
        ...
        >
          ...
          <Stack>
            ...
            <Text color={"gray.500"}>
              ...
              your bodybuilding goals much faster.
            </Text>
          </Stack>
          <Stack mt={6} direction={"row"} spacing={4} align={"center"}>
            <Avatar src={Entrenador2} alt={"Author"} />
