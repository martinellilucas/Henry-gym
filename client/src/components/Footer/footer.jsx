...
const Footer = () => {
  const imageUrl =
    "https://cdn.discordapp.com/attachments/1105187840230441004/1105887915847983204/logo.jpeg.png";
    ...
    <div className={Style.contenedor}>
      <div className={Style.footer}>
        ...
        <div className={Style.igywhat}>
          ...
          <a
            href='"whatsapp://send?phone=NUMERO&text=Hola%20quiero%20contactar%20contigo"'
            target="_blank"
          >
