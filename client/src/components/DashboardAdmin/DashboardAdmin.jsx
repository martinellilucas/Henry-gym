...
import Mati from '../../assets/matichiquito.jpg';
...
const LinkItems = [
  ...
  { name: 'Mis Rutinas', icon: FiStar },
  { name: 'Configuracion', icon: FiSettings },
  { name: 'Volver al Sitio Web', icon: FiCompass, url: '/home' },
];
