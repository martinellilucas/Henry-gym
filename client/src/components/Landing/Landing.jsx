  ...
  return (
    <Box display='flex' flexDirection="column" position='relative' scrollMarginY='0px'>
      ...
      <Box width='100%' height='339px' background='#28242b' display='flex' justifyContent='space-evenly' alignItems='center' position='absolute' top='600px'>
        <Box as='button' borderRadius='md' bg='black' color='white' height='90px' width='200px' fontFamily=''>
          Ingresar
        </Box>
        ...
        <NavLink to='/home'>
        <Box as='button' borderRadius='md' bg='tomato' color='white' height='100px' width='150px'>
          Explorar
        </Box>
        </NavLink>
